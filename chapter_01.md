...
「わかりました。そのフィーチャを実装できますが、いろんなところに影響がでますよ」。

もう少し経験を積んでいるプログラマたちは、これとはまた違ったデザインの失敗に遭遇します。彼らはオブジェクト指向デザインのテクニック
を意識していますが、それをどうやって適用すればよいのかまだ理解できていません。その意気込みが、逆に彼らを過剰なデザインという罠にはめます。
生半可な知識ほど危険なものはありません。知識が増え、その見返りを望むようになるにしたがって、彼らはむやみやたらに「デザイン」します。
興奮が過ぎていて、パターンを適切に適用せず、何もないところにでもパターンを発見します。彼らが作り出すのは、複雑で美しいコードのお城です。
そして自分たちが城壁に囲まれ閉じ込められていることを知って苦しみます。あなたは彼らのようなプログラマを知っているのではないでしょうか。
彼らは変更要求に対してこのように応えるでしょう。「いや、そのフィーチャは追加できませんね。そのようなフィーチャを追加できるようにデザインしていなんです」。
...
オブジェクト指向アプリケーションの開発に完璧に適合するのです。アジャイル開発のイテレイティブな特性は、デザインを定期的に見直し、
無理なく発展させてくれます。デザインがどこか遠くから啓示されるものなら、見直すことなどなにもありませんが、啓示の内容を理解し
