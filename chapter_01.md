...
のプログラムに匹敵します。しかしパターンの普及は駆け出しプログラマによるパターンの乱用を誘発しました。本人はよかれと思いながら、
まったく正しいパターンをまったくお門違いな問題解決に適用してしまうのです。パターンの誤用は、複雑で混乱したコードを生みだします。
...
共通のデザイン原則とパターンの発見と普及により、オブジェクト指向デザインの問題はすべて解決されたかのようにみえました。
基本的な原則が知られたいま、オブジェクト指向ソフトウェアをデザインすることはそれほどハードなことなのでしょうか？
結局、かなりハードであることに変わりません。ソフトウェアをカスタム家具のように考えるならば、原則とパターンは木工道具のようなものです。
ソフトウェアが完成したときそれがどう見えるべきか知ることは、ソフトウェアを書くことには影響しません。アプリケーション
がこの世に現れたのは、あるプログラマが木工道具を使ったからです。美しいキャビネットになるかぐらぐらする椅子になるかは、
プログラマがどれくらいデザインツールを使いこなせるかにかかっているのです。
