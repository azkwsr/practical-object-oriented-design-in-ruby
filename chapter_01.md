...
基本となるルールが知られたいま、オブジェクト指向なソフトウェアをデザインすることのどこがそんなに難しいことなののでしょうか？
...
オブジェクト指向言語のうちいくつかは他の言語と比べてより柔軟で、Ruby のようにとっつきやすい言語は特に脆弱と言えます。
...
開発の誓いが徐々に崩れていき、楽観は絶望へとく変わります。そうして、プログラマは変更要求ひとつひとつにこう応じるようになります。
「わかりました。そのフィーチャを実装はできますがいろんなところに影響がでますよ」と。

もう少し経験を積んだプログラマたち、これとはまた違うデザイン上の失敗に遭遇します。彼らはオブジェクト指向デザインのテクニックを
